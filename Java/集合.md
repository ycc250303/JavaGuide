...
![1759975954773](image/集合/1759975954773.png)
...
![1759977812425](image/集合/1759977812425.png)
...
![1760070063070](image/集合/1760070063070.png)
...
| 国庆 | 2024                                                                                         | 2025                                     |
| ---- | -------------------------------------------------------------------------------------------- | ---------------------------------------- |
| 内容 | 学数据结构，在实验室调车                                                                     | 刷算法看八股、学Java做项目               |
| 作息 | 不规律，有几天调车调到两三点                                                                 | 比较规律，基本都在一点前躺床             |
| 成果 | 过了一遍数据结构，为新车型写了一套控制代码                                                   | 算法十几题，Java学到集合                 |
| 不足 | 自己调车测试不足，一个函数的参数出了错误<br />被实验室负责人扫地出门，其他的代码再没有被用过 | 窝在宿舍八天，精力逐渐下降，产出逐渐减少 |
